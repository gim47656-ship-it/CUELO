...
import { getLocalePlugin, getSupportedLocales, resolveLocalePreference } from "@/lib/i18n/registry";
...
function readInitialLocale(): Locale {
  ...
  return resolveLocalePreference(stored, languages);
}

/**
 * 提供 CUELO 的界面语言状态和翻译能力。
