...
const { Settings } = await jiti.import("@oh-my-pi/pi-coding-agent/config/settings");
...
function fixture(provider = "openai-codex") {
  ...
  const session = {
    ...
    settings: Settings.isolated({ "codexResets.minBlockedMinutes": 60, "codexResets.keepCredits": 0, "codexResets.salvageHorizonHours": 12 }),
